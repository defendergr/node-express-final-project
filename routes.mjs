...
router.get("/comments/:title", UserController.checkIfAuthenticated, BookController.showComment)
router.post("/doaddcomment", UserController.checkIfAuthenticated, BookController.addComment)
